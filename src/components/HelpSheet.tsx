...
const STEPS: [string, string][] = [
  ['設定請假預算', '點左下角的「請假 x / y」，抓一下今年打算請幾天假——特休、補休、婚假都算，只是規劃參考。'],
  [
    '點上班日標記請假',
  ...
  [
    '匯出與分享',
    '「匯出」給自己：備份連結、.ics 進 Google／Apple 日曆。「分享」給別人：推薦工具，或把行程傳給朋友（不含備註）。',
  ],
];
...
export function HelpContent() {
  return (
    <>
      ...
      <p className="settings-footnote">
        放假日以行政院人事行政總處核定的辦公日曆表為準（無補班日）；勞基法適用的公司可能略有不同。
      </p>
    </>
  );
}
